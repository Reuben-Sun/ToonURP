Shader "Toon/Grass"
{
	...
	geometryOutput GenerateGrassVertex(float3 pos, float width, float height, float forward, float2 uv, float3x3 transforMatrix)
	{
	...
	void geo(triangle vertexOutput IN[3]: SV_POSITION, inout TriangleStream<geometryOutput> triStream)
	{
		...
		float3x3 transformationMatrixFacing = mul(tangentToLocal, facingRotationMatrix);  // to ensure that the grass are pinned to the ground.
