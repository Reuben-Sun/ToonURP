Shader "ToonURP/ToonStandard"
{
    Properties
    {
    	...
    	[SubToggle(ShadingMode)] [ShowIf(_EnumShadingMode, NEqual, 1)] _UseHalfLambert ("Use HalfLambert (More Flatter)", float) = 0
        [SubToggle(ShadingMode)] [ShowIf(_EnumShadingMode, NEqual, 1)] _UseRadianceOcclusion ("Radiance Occlusion", float) = 0
    	[Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NEqual, 1)] _SpecularColor ("Specular Color", Color) = (1,1,1,1)
    	[Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NEqual, 1)] [HDR] _HighColor ("Hight Color", Color) = (1,1,1,1)
        [Sub(ShadingMode)] [ShowIf(_EnumShadingMode, NEqual, 1)] _DarkColor ("Dark Color", Color) = (0,0,0,1)
        [Sub(ShadingMode_CELLSHADING)] _CellThreshold ("Cell Threshold", Range(0.01,1)) = 0.5
        [Sub(ShadingMode_CELLSHADING)] _CellSmoothing ("Cell Smoothing", Range(0.001,1)) = 0.001
    	[Sub(ShadingMode_CELLSHADING)] _SpecularIntensity ("Specular Intensity", Range(0,8)) = 1
        [Sub(ShadingMode_CELLSHADING)] _SpecularSize ("Specular Size", Range(0,1)) = 0.1
        [Sub(ShadingMode_CELLSHADING)] _SpecularSoftness ("Specular Softness", Range(0.001,1)) = 0.05
        [Sub(ShadingMode_CELLSHADING)] _SpecularAlbedoWeight ("Color Albedo Weight", Range(0,1)) = 0
    	[Sub(ShadingMode_CELLSHADING)] _ScatterColor ("Scatter Color", Color) = (1,1,1,1)
    	[Sub(ShadingMode_CELLSHADING)] _ScatterWeight ("Scatter Weight", Range(4,20)) = 10
